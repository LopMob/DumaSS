...
| GET | `/meetings?commission_id=&status=` | Список заседаний думы (можно отфильтровать по комиссии и/или по статусу: `scheduled`\|`held`\|`cancelled`); сортировка — по дате заседания |
